...
from training.functions.pennylane_functions import predict_circuit, get_valid_states
...
if __name__ == "__main__":
    ...
    root_directory = this_folder + "/training/results"
    keywords = ["F1Data", str(num_classes)]
